/*
	...
	exec sp_FC_FM_Export_Excel_File_TEST 'CPD','202406','Baseline Qty','',@b_Success OUT,@c_errmsg OUT

	select @b_Success b_Success,@c_errmsg c_errmsg
	
*/

Create or Alter proc sp_FC_FM_Export_Excel_File_TEST
	@Division			Nvarchar(3),
	@FMKEY				nvarchar(6),
...
BEGIN TRY
	...
	begin
		...
		insert into '+@tablename+' exec link_33.sc2.dbo.sp_FC_EXPORT_TO_FM '''+@Division+''','''+@FMKEY+''','''+@Channel+''','''+@Timeseries+''','''+@Subgrp+'''
