/*
exec sp_add_FC_SI_FOC_Tmp 'SI_FOC_SINGLE.xlsx'

select * from FC_SI_FOC_Tmp

*/
Create or Alter proc sp_add_FC_SI_FOC_Tmp
	@Division			nvarchar(3),
...
select @tablename = 'FC_SI_FOC_'+@Division+'_Tmp'
