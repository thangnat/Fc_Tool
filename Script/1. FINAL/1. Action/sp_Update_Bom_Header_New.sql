/*
	...
	exec sp_Update_Bom_Header_New 'CPD','202407','ONLINE','XVN00234','Y0 (u) M7','174',@b_Success OUT,@c_errmsg OUT

	select @b_Success b_Success,@c_errmsg c_errmsg
*/

Alter Proc sp_Update_Bom_Header_New
	@Division				Nvarchar(3),
	@FM_KEY					nvarchar(6),
	@Channel				nvarchar(7),
...
BEGIN TRY
	...
	SELECT	
		...
		@n_err=0,
		@c_errmsg='', 
		@sp_name = 'sp_Update_Bom_Header_new',
		@USERS = SUSER_NAME(),
		@MODIFILED = GETDATE()
	...
	if @n_continue=1
	begin
		exec sp_Update_Bom_Header @Division,@FM_KEY,@Channel,@BundleCode,@ColumnName,@Value,@b_Success1 OUT,@c_errmsg1 OUT
		if @b_Success1 = 0
		begin
