/*
	...
	exec sp_FC_Create_Backup_Version_WF 'CPD','202407','',@b_Success OUT,@c_errmsg OUT

	select @b_Success b_Success,@c_errmsg c_errmsg

	select * from FC_FM_Original_LDB_His
*/
Alter proc sp_FC_Create_Backup_Version_WF
	@Division			nvarchar(3),
	@FM_KEY				nvarchar(6),
...
BEGIN TRY
	...
	SELECT	
		...
		@n_err=0,
		@c_errmsg='', 
		@sp_name = 'sp_FC_Create_Backup_Version_WF',
		@USERS = SUSER_NAME(),
		@MODIFILED = GETDATE()
