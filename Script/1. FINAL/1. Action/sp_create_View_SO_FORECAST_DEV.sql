/*
	...
	exec sp_create_View_SO_FORECAST_DEV 'LLD','202410',@b_Success OUT,@c_errmsg OUT

	select @b_Success b_Success,@c_errmsg c_errmsg
	
	select * from V_FC_LLD_202410_SO_FORECAST
*/

Alter proc sp_create_View_SO_FORECAST_DEV
	@division		nvarchar(3),
	@FM_KEY			nvarchar(6),
