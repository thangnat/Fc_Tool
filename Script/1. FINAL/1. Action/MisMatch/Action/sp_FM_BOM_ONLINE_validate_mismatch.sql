/*
	...
	exec sp_FM_BOM_ONLINE_validate_mismatch 'PPD','202410',@b_Success OUT, @c_errmsg OUT
	...
	*/
*/
Alter proc sp_FM_BOM_ONLINE_validate_mismatch
	@Division		nvarchar(3),
	@FM_KEY			nvarchar(6),
...
BEGIN TRY
	...
	SELECT	
		...
		@n_err=0,
		@c_errmsg='', 
		@sp_name = 'sp_FM_BOM_ONLINE_validate_mismatch',
		@USERS = SUSER_NAME(),
		@MODIFILED = GETDATE()	
	...
	declare @FunctionName		nvarchar(50)='FM_BOM_ONLINE'
