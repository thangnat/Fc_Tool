/*
	...
	exec sp_Create_List_Bom_Header_Forecast_All 'CPD','202407',@b_Success OUT, @c_errmsg OUT
...
Alter Proc sp_Create_List_Bom_Header_Forecast_All
	@Division				nvarchar(3),
	@FM_KEY					nvarchar(6),
...
BEGIN TRY
	...
	SELECT	
		...
		@n_err=0,
		@c_errmsg='', 
		@sp_name = 'sp_Create_List_Bom_Header_Forecast_All',
		@USERS = SUSER_NAME(),
		@MODIFILED = GETDATE()
