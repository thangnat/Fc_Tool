/*--30 giây
	...
	exec sp_Create_V_His_SI_Final_NEW 'LLD','202412','MTD','h',@b_Success OUT,@c_errmsg OUT

	select @b_Success b_Success,@c_errmsg c_errmsg
	
	select * 
	from LDB_202410_His_SI_Single_Final
...
Alter Proc sp_Create_V_His_SI_Final_NEW
	@Division			nvarchar(3),
	@FM_KEY				nvarchar(6),
	@Type				nvarchar(3),--//MTD,''-->Single
	@Alias				nvarchar(5),
...
BEGIN TRY
	...
	SELECT	
		...
		@n_err=0,
		@c_errmsg='', 
		@sp_name = 'sp_Create_V_His_SI_Final_NEW',
		@USERS = SUSER_NAME(),
		@MODIFILED = GETDATE()
