...
namespace WinFormsApp2
{
    public class Connection_SQL
    {
        ...
        public static string _form_active = string.Empty;
        ...
        public static void KetnoiCSDL_SQL()
        {
            try
            {
                //Constr = @"Data Source=10.240.65.33;Initial Catalog=SC2;User ID=" + ((_userID.Length == 0) ? "sa" : _userID) + ";Password=" + ((_userID.Length == 0) ? "Saigon@SQL2023" : "sgl789") + ";Connect Timeout=3600000";
                Constr = @"Data Source="+_serverName+";Initial Catalog="+_DatabaseName+";User ID=" + ((_userID.Length == 0) ? "sa" : _userID) + ";Password=" + ((_userID.Length == 0) ? "Saigon@SQL2023" : "sgl789") + ";Connect Timeout=3600000";
            ...
            catch(Exception ex)
            {
                ...
                MessageBox.Show(ex.Message+"-->Connection fail...", "Loreal VN", MessageBoxButtons.OK,MessageBoxIcon.Stop);
            }
        }
        ...
        public bool Exec_StoreProc(string sStoreProc, ArrayList _parasName, ArrayList _parasValue)
        {
            ...
            try
            {
                ...
                cmd.Connection = Connection_SQL.cnn;
                cmd.CommandTimeout = 0;
                cmd.CommandType = CommandType.StoredProcedure;
